		...
		<div class="containerHead" align="center">
			...
			<div class="grid-container">
				...
				<div class="grid-item">
						...
						<img  class="avatar alignHorizontally" src="1.png" style="width:30px;height:30px;" alt="Avatar">
				...
				<div class="grid-item">
						<img src="newgif.gif" alt="this slowpoke moves"  width=250/>
						<p class="project_title">Cpp Raytracer</p>
						<p class="project_description">This is a description</p>
				</div>
				<div class="grid-item">
						<img src="newgif.gif" alt="this slowpoke moves"  width=250/>
				</div>
